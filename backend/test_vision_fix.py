...
def test_vision_processing():
    ...
    try:
        ...
        result = analyzer._parse_analysis_response(fallback_text, AnalysisLevel.CLINICAL)
        ...
        result2 = analyzer._parse_analysis_response(template_text, AnalysisLevel.CLINICAL)
...
def test_claude_vision_method():
    ...
    try:
        ...
        assert hasattr(claude, 'generate_vision_response'), "generate_vision_response method missing"
