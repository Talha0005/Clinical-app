...
class TestPromptsAPI:
    ...
    def test_get_prompt_by_id_not_found(self, client, temp_prompts_service, auth_headers):
    ...
    def test_update_prompt_success(self, client, temp_prompts_service, auth_headers):
        ...
        response = client.put("/api/prompts/test_system", 
                            json=update_data, 
    ...
    def test_update_prompt_not_found(self, client, temp_prompts_service, auth_headers):
        ...
        response = client.put("/api/prompts/non_existent", 
                            json=update_data, 
                            headers=auth_headers)
    ...
    def test_create_prompt_already_exists(self, client, temp_prompts_service, auth_headers):
    ...
    def test_prompt_validation(self, client, temp_prompts_service, auth_headers):
        ...
        response = client.post("/api/prompts", json=invalid_prompt, headers=auth_headers)
