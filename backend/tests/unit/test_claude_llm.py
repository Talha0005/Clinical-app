...
class TestClaudeLLM:
    ...
    def test_conversation(self):
        ...
        conversation = ConversationHistory(
            messages=[], conversation_id="test-123", created_at=datetime.now()
        )
    ...
    async def test_generate_response_success(self, claude_llm, test_conversation):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            response = await claude_llm.generate_response(
                test_conversation, "I have a headache", temperature=0.8, max_tokens=500
            )
    ...
    async def test_generate_response_api_error(self, claude_llm, test_conversation):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            response = await claude_llm.generate_response(
                test_conversation, "Test message"
            )
    ...
    @pytest.mark.asyncio
    async def test_generate_response_invalid_response_format(
        self, claude_llm, test_conversation
    ):
    ...
    @pytest.mark.asyncio
    async def test_generate_response_default_system_prompt(
        self, claude_llm, test_conversation
    ):
    ...
    async def test_generate_streaming_response_success(
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            chunks = []
            async for chunk in claude_llm.generate_streaming_response(
    ...
    @pytest.mark.skip("Complex async mocking - core functionality tested elsewhere")
    @pytest.mark.asyncio
    async def test_generate_streaming_response_api_error(
        self, claude_llm, test_conversation
    ):
    ...
    @pytest.mark.skip("Complex async mocking - core functionality tested elsewhere")
    @pytest.mark.asyncio
    async def test_generate_streaming_response_network_error(
        self, claude_llm, test_conversation
    ):
    ...
    @pytest.mark.skip("Complex async mocking - core functionality tested elsewhere")
    @pytest.mark.asyncio
    async def test_generate_streaming_response_invalid_json(
        self, claude_llm, test_conversation
    ):
    ...
    async def test_health_check_success(self, claude_llm):
        ...
        mock_response = {"content": [{"text": "API connection successful."}]}
    ...
    async def test_health_check_unexpected_response(self, claude_llm):
        ...
        mock_response = {"content": [{"text": "Unexpected response"}]}
