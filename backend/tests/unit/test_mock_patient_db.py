...
class TestMockPatientDB:
    ...
    def test_get_patient_list(self, mock_patient_db):
        ...
        assert patient_list[0] == {"name": "John Smith", "national_insurance": "AB123456C"}
        assert patient_list[1] == {"name": "Jane Doe", "national_insurance": "CD789012E"}
    ...
    def test_create_new_patient_duplicate_ni(self, mock_patient_db):
        ...
        with pytest.raises(ValueError, match="Patient with National Insurance .* already exists"):
